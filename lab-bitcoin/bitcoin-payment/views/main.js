...
function check_details() {
    ...
    $.ajax({
        ...
        datatype: 'binary',
        processData: false,
        success: function (data) { get_payment_details(data); }
    });
}

// Bower not support bitcore-payment-protocol and BIP 70 will be remove =,.=???
